...
button_restart_click =  pygame.image.load(os.path.join(r'level_2/Utils/Pics/Interface/Buttons','Button_Restart_click.png'))
...
button_about_click =  pygame.image.load(os.path.join(r'level_2/Utils/Pics/Interface/Buttons','Button_About_click.png'))

button_highscore =  pygame.image.load(os.path.join(r'level_2/Utils/Pics/Interface/Buttons','Button_HighScore.png'))
...
button_instructions_click =  pygame.image.load(os.path.join(r'level_2/Utils/Pics/Interface/Buttons','Button_Instructions_click.png'))
...
button_play_click =  pygame.image.load(os.path.join(r'level_2/Utils/Pics/Interface/Buttons','Button_Play_click.png'))
...
button_resume_click =  pygame.image.load(os.path.join(r'level_2/Utils/Pics/Interface/Buttons','Button_Resume_click.png'))
...
class Cursor:
	...
	"""
	def __init__(self):
		self.img = pygame.image.load(os.path.join(r'level_2/Utils/Pics/Interface', 'cursor.png')).convert_alpha()
...
class Mute_button:
	...
	def __init__(self):
		...
		self.img_original = pygame.image.load(os.path.join(r'level_2/Utils/Pics/Interface', 'mute.png')).convert_alpha()
...
class Unmute_button:
	...
	def __init__(self):
		...
		self.img_original = pygame.image.load(os.path.join(r'level_2/Utils/Pics/Interface', 'unmute.png')).convert_alpha()		
		self.img_small = pygame.transform.scale(self.img_original,(int(self.img_original.get_width()), int(self.img_original.get_height())))
		self.img_big = pygame.transform.scale(self.img_original,(int(self.img_original.get_width()*1.1), int(self.img_original.get_height()*1.1)))
