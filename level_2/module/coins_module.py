...
coin_board1 = pygame.image.load(os.path.join(r'level_2/Utils/Pics/Display','score_board.png'))
coin_board = pygame.transform.scale(coin_board1, (int(coin_board1.get_width()//1.1), int(coin_board1.get_height()//1.1)))
