...
from level_2.mp import queue_shared, process_object
...
screen_instruction3 =  pygame.image.load(os.path.join(r'level_2/Utils/Pics/Interface/Instructions','Instructions_screen3.png'))
screen_instruction5 =  pygame.image.load(os.path.join(r'level_1/Utils/Pics/Interface/Instructions','Instructions_screen5.png'))
screen_instruction4 =  pygame.image.load(os.path.join(r'level_2/Utils/Pics/Interface/Instructions','Instructions_screen4.png'))
...
button_mode_gesture =  pygame.image.load(os.path.join(r'level_2/Utils/Pics/Interface/ModeOfGame','Mode_HandGesture.png'))
...
button_mode_mouse =  pygame.image.load(os.path.join(r'level_2/Utils/Pics/Interface/ModeOfGame','Mode_Mouse.png'))
...
index_finger_not_detected1 = pygame.image.load(os.path.join(r'level_2/Utils/Pics/Interface','pop-up.png'))
