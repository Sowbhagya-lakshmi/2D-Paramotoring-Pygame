...
# LIVES
heart = pygame.image.load(os.path.join(r'level_2/Utils/Pics/Display/', 'life.png'))
...
class Extra_life:
	def __init__(self):
		...
		self.img = pygame.image.load(os.path.join(r'level_2/Utils/Pics/Display/', 'extra_life.png'))
...
# MINIMAP
line = pygame.image.load(os.path.join(r'level_2/Utils/Pics/Display/','line.png'))
...
class Countdown:
	num_of_imgs = 3
	imgs_big = [pygame.image.load(os.path.join(r'level_2/Utils/Pics/Countdown/',str(x) + '.png')) for x in range(num_of_imgs, 0, -1)]
	imgs = [pygame.transform.scale(img, (img.get_width()//2, img.get_height()//2)) for img in imgs_big]
	imgs.append(pygame.image.load(os.path.join(r'level_2/Utils/Pics/Countdown/','go.png')))
	num_of_imgs = 4

	level_num_img = pygame.image.load(os.path.join(r'level_2/Utils/Pics/Display/','title.png'))
	level_name_img = pygame.image.load(os.path.join(r'level_2/Utils/Pics/Display/','title_name.png'))
...
class Fuel:
	...
	def __init__(self):
		...
		free_zone_y = coins_module.find_free_zone_y()
		self.y = random.randint(0,free_zone_y)	
		self.img = pygame.image.load(os.path.join(r'level_2/Utils/Pics/Display/','fuel2.png'))
...
class Pause_button:
	...
	def __init__(self):
		...
		self.img_original = pygame.image.load(os.path.join(r'level_2/Utils/Pics/Display', 'pause.png'))
...
class Play_button:
	...
	def __init__(self):
		...
		self.img_original = pygame.image.load(os.path.join(r'level_2/Utils/Pics/Display', 'play.png'))		
		self.img_small = pygame.transform.scale(self.img_original,(int(self.img_original.get_width()), int(self.img_original.get_height())))
		self.img_big = pygame.transform.scale(self.img_original,(int(self.img_original.get_width()*1.1), int(self.img_original.get_height()*1.1)))
