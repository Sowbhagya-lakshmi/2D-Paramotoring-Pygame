...
fail_msg_big = pygame.image.load(os.path.join(r'level_1/Utils/Pics/Interface','oh_no.png'))
fail_msg = pygame.transform.scale(fail_msg_big, (fail_msg_big.get_width()//3, fail_msg_big.get_height()//3))

success_msg_big = pygame.image.load(os.path.join(r'level_1/Utils/Pics/Interface','we_made_it.png'))
