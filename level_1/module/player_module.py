...
class Player:
	...
	imgs_big = [pygame.image.load(r'level_1/Utils/Pics/Player/'+img) for img in img_name_lst]
...
class Propeller:
	...
	path = r'level_1/Utils/Pics/Propeller/'
	img_name_lst = os.listdir(path)
	num_of_propeller_imgs = len(img_name_lst)

	# Loading propeller images
	org_propeller_imgs = [pygame.image.load(r'level_1/Utils/Pics/Propeller/'+img) for img in img_name_lst]
