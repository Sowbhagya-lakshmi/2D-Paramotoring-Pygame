...
#sound_button_click = pygame.mixer.Sound(os.path.join('Utils\Music\button_click_soundeffect.wav'))
#sound_button_enlarge = pygame.mixer.Sound(os.path.join('Utils\Music\button_enlarge_soundeffect.wav'))